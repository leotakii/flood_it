...
void fronteira_mapa_cores(tmapa*, tfronteira*);
void fronteira_area_mapa(tmapa*, tfronteira*);

void distancia_mapa(tmapa*, tmapa*, int, int);
void soma_mapa(tmapa*, tmapa*);
